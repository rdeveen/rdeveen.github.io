...
![Azure Logic App to Start an Azure Virtual Machine](./images/AzureLogicApptoStartanAzureVirtualMachine.webp)
...
![Auto shutdown Azure Virtual Machine](./images/AutoShutdown.webp)
...
![Logic App Recurrence Trigger](./images/LogicAppRecurrenceTrigger.webp)
...
![Logic App HTTP action](./images/HttpAction.webp)
...
![Enable Managed Identity on the Logic App](./images/Identity.webp)
...
![Give the Logic App the role Virtual Machine Contributor](./images/RoleAssignment.webp)
